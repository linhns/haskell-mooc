...
step Floured AddSugar = Dough
step Sugared AddFlour = Dough
...
passwordAllowed s (ContainsSome sub) = not $ null $ intersect s sub
passwordAllowed s (DoesNotContain sub) = null $ intersect s sub
